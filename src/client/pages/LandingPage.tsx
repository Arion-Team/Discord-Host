    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#0a0a0a]/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/register" className="rounded-lg bg-white px-4 py-2 text-sm font-semibold text-black hover:bg-gray-100 transition-all">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-16">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link to="/register" className="flex items-center gap-2 rounded-xl bg-white px-8 py-3.5 text-base font-semibold text-black hover:bg-gray-100 transition-all active:scale-[0.98]">
              Get Started Free
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-white/[0.02] p-12 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link to="/register" className="flex items-center gap-2 rounded-xl bg-white px-8 py-3.5 text-base font-semibold text-black hover:bg-gray-100 transition-all">
